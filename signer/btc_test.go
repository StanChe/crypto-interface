	...
	cases := []struct {
		...
		},
		{
			...
			func(t *testing.T) {
				...
				signer := NewBtcSigner("BTC", component1, &BtcNetParams, nil)
		...
		},
		{
			...
			func(t *testing.T) {
				signer := NewBtcSigner("BTC", component1, &BtcNetParams, BtcTxInputSignature)
		...
		},
		{
			...
			func(t *testing.T) {
				signer := NewBtcSigner("BTC", component2, &BtcNetParams, BtcTxInputSignature)
				txData := []byte("")
		...
		},
		{
			...
			func(t *testing.T) {
				signer := NewBtcSigner("BTC", component3, &BtcNetParams, BtcTxInputSignature)
				txData := []byte("")
